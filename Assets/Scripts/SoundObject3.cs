...
public class SoundObject3 : MonoBehaviour
{
    ...
    void Start()
    {
        pitchArr = ControlFunctions.PitchArray(0, new Vector2Int(12, 36), new int[] { 2, 1, 2, 2, 2, 1 });
    }
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(-4, lfo, lfo * 4);
